...
[1] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    ...
    KC_CAPS, _______, RGB_SPI, RGB_VAI, RGB_SAI, RGB_HUI, RGB_MOD, RGB_TOG, KC_PSCR,  KC_PAUS, KC_UP, _______, _______, _______,
    _______, _______, RGB_SPD, RGB_VAD, RGB_SAD, RGB_HUD, RGB_RMOD, _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT,            _______,
